...
const Layout = ({ children }: { children: React.ReactNode }) => {
  ...
  return (
    <div className="min-h-screen md:h-screen flex flex-col overflow-visible md:overflow-hidden md:overscroll-none">
      {/* Header */}
      <header className="fixed md:absolute top-0 left-0 right-0 flex items-center justify-between px-[4vw] pb-[0.9vw] pt-3 md:pt-0 bg-white md:bg-transparent z-50">
      ...
      {/* Page content */}
      <main className="flex-1 pt-[70px] md:pt-0 overflow-visible md:overflow-hidden">
        {children}
      </main>
    </div>
  );
