...
const Contact = () => {
  ...
  return (
    <div className="relative flex items-center justify-center px-[2vw] lg:px-16 xl:px-24 md:fixed md:inset-0 md:z-10 pointer-events-none pt-20 pb-[clamp(48px,10vw,80px)] lg:pt-0 lg:pb-0 safe-area-top safe-area-bottom">
