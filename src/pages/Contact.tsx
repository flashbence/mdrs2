...
const Contact = () => {
  ...
  return (
    <div className="relative flex items-center justify-center px-[2vw] md:px-16 lg:px-24 md:fixed md:inset-0 md:z-10 pointer-events-none pt-20 pb-[80px] md:pt-0 md:pb-0">
