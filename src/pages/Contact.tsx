...
const Contact = () => {
  ...
  return (
    <div className="relative flex items-center justify-center px-8 md:px-16 lg:px-24 md:fixed md:inset-0 md:z-10 pointer-events-none pt-[calc(0.9vw+45px)] sm:pt-0">
