...
const Index = () => {
  ...
  return (
    <div className="relative min-h-[100dvh] md:h-screen overflow-visible md:overflow-hidden bg-white pb-[env(safe-area-inset-bottom)]">
      ...
      <div className="relative z-10 flex min-h-[100dvh] md:h-full flex-col items-center justify-center sm:justify-end pb-0 pt-[120px]">
        {/* Text content */}
