...
const Index = () => {
  ...
  return (
    <div className="relative min-h-screen md:h-screen overflow-visible md:overflow-hidden bg-white">
      ...
      <div className="relative z-10 flex h-full flex-col items-center justify-center sm:justify-end pb-0 pt-[120px]">
        {/* Text content */}
        <div className="px-4 sm:px-8 md:px-16 lg:px-24 text-center mb-6 shrink-0 min-w-0 w-full">
          ...
          <p className="<p className="text-sm sm:text-sm md:text-base font-light text-muted-foreground leading-relaxed mb-6 max-w-4xl mx-auto font-body break-words"> font-light text-muted-foreground leading-relaxed mb-6 max-w-4xl mx-auto font-body break-words">
            {t("home.subtitle")}
          </p>
          <Link
            to="/about"
