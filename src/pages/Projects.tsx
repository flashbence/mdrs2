...
const Projects = () => {
  ...
  return (
    <div
      className="min-h-svh md:h-full md:min-h-0 relative flex flex-col items-center px-[4vw] sm:px-[8vw] font-body overflow-visible md:overflow-hidden safe-area-top safe-area-bottom"
      style={{
