  ...
  return (
    <div className="h-full relative flex flex-col items-center justify-center px-4 md:px-8 bg-white">
      ...
      <div className="relative z-10 w-full max-w-[1400px] flex flex-col items-stretch" style={{ height: '75vh' }}>
        ...
        <div className="flex flex-wrap gap-2 mb-0">
          {categories.map((cat) => (
            <button
              ...
              className={`px-4 py-1 rounded-[11px] text-[0.89em] font-normal cursor-pointer transition-all duration-200
        ...
        {/* Table */}
        <div className="w-full rounded-[14px] overflow-hidden flex-1 min-h-0" style={{ maxHeight: '300px', overflowY: 'auto', WebkitOverflowScrolling: 'touch' }}>
